...
if (NOT WIN32)
    ...
    if (CMAKE_SYSTEM_NAME STREQUAL Darwin)
        ...
        if(DEFINED ENV{ROOTFS_DIR})
            if(CMAKE_SYSTEM_PROCESSOR STREQUAL armv7l OR CMAKE_SYSTEM_PROCESSOR STREQUAL aarch64 OR CMAKE_SYSTEM_PROCESSOR STREQUAL i686 OR CMAKE_SYSTEM_PROCESSOR STREQUAL mips64)
                find_program(OBJCOPY ${TOOLCHAIN}-objcopy)
            else()
                message(FATAL_ERROR "Only AMD64, X86, ARM64, ARM and MIPS64 are supported")
            endif()
        else()
...
elseif(CLI_CMAKE_PLATFORM_ARCH_MIPS64)
    add_definitions(-D_TARGET_MIPS64_=1)
    set(ARCH_SPECIFIC_FOLDER_NAME "mips64")
else()
